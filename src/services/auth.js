...
import { APP_DOMAIN, FIFTEEN_MIN, JWT_SECRET, SMTP, TEMPLATES_DIR, THIRTY_DAYS } from "../constants/index.js"
...
export const refreshUserSession = async ({ sessionId, refreshToken }) => {
    ...
    const refreshTokenExpired = new Date() > new Date(session.refreshTokenValidUntil)

    if (refreshTokenExpired) throw createHttpError(401, "Session token expired")
...
export const resetPwd = async (resetData) => {
    let entries
